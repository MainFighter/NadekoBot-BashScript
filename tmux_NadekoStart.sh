...
if [ $choice -eq 1 ] ; then
	...
	sleep 1
	wget -N https://raw.githubusercontent.com/MainFighter/NadekoBot-BashScript/1.4/tmux_NadekoAutoRestart.sh
	...
	if [ $choice -eq 2 ] ; then
		...
		sleep 1
		wget -N https://raw.githubusercontent.com/MainFighter/NadekoBot-BashScript/1.4/tmux_NadekoAutoRestartAndUpdate.sh
